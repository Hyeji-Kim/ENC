...
def VBMF(Y, cacb, sigma2=None, H=None):
    ...
    #Formula above (21) from [1] : truncation threshold (for SimpleVB solution)
    ...
    #Formula (10) from [2] : shrinkage estimator (gamma_h^VB)
    d = np.multiply(s[:pos], 
...
#        print sigma2
    ...
    #Formula (15) from [2] : shrinkage estimator (for EVB solution)
    ...
    # sa2    : sum_a^2 (diagonal matrix of SVD). Covariance matrix of d-dim. Gaussian distribution
    # cacb   : prior covariance matrices (Hyperparameters) - if covariance is large, matrix is almost diagonal
    # sigma2 : variance of Gaussian distribution (if it is unknown, estimated based on F minimization)
    # F      : free energy
